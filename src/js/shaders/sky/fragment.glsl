...
//   float threshold1up = 0.7  + 0.1;
//   float threshold1down = 1. - 0.1;
...
//   float step1 = smoothstep(threshold1up, threshold1down + size1/1. , vUv.y  +  size1) - smoothstep(threshold1down - size1/1.,threshold1down, vUv.y - size1 );
